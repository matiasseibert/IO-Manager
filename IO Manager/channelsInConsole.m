...
@interface channelsInConsole()
@property (nonatomic, strong) NSArray *channels;
@property (nonatomic, strong) Console *myConsole;
@end

@implementation channelsInConsole
@synthesize delegate, channels, myConsole;
...
- (id)initWithConsole:(Console *)console;
{
    ...
    if (self) {
        myConsole = console;
        channels = [[DataManager sharedInstance] getOpenInputChannelsForConsole:myConsole];
    }
    return self;
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [dataManager connectInput:[delegate getInput] toConsole:self.myConsole inChannel:c];
